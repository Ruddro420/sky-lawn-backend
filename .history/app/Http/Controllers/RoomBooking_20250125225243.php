        ...
        foreach ($data['bookings'] as $index => $bookingData) {
            try {
                ...
                $validator = Validator::make($bookingData, [
                    ...
                    'nid_doc' => 'nullable|array|mimes:jpg,jpeg,png,pdf|max:2048', // updated for multiple files
                    'couple_doc' => 'nullable|array|mimes:jpg,jpeg,png,pdf|max:2048', // updated for multiple files
                    'visa_doc' => 'nullable|array|mimes:jpg,jpeg,png,pdf|max:2048', // updated for multiple files
                    'other_doc' => 'nullable|array|mimes:jpg,jpeg,png,pdf|max:2048', // updated for multiple files
                ]);
